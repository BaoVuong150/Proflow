...
ProFlow is a modern, enterprise-grade Kanban board application (Trello clone) designed for efficient team collaboration. Built with **Laravel 13 (Octane)** on the backend and **React 19** on the frontend, focusing on clean architecture, real-time synchronization, and a premium user experience.
...
ProFlow là một ứng dụng quản lý công việc theo chuẩn Kanban (tương tự Trello) được thiết kế chuyên nghiệp dành cho làm việc nhóm. Ứng dụng được xây dựng trên nền tảng **Laravel 13 (Octane)** cho Backend và **React 19** cho Frontend, tập trung vào kiến trúc sạch, đồng bộ thời gian thực và trải nghiệm người dùng cao cấp.
